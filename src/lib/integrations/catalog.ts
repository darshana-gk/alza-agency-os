...
export const INTEGRATION_PROVIDER_CATALOG: readonly IntegrationProviderDefinition[] = [
  ...
  {
    id: 'alza_commission_statement_import',
    name: 'Commission Statement Import',
    category: 'data_import_export',
    description:
      'Import carrier/MGA commission statements via CSV, XLSX, TXT, or paste. Uses existing Reconciliation — not a second matching engine.',
    availability: 'available',
    fallbackPath: '/reconciliation',
    keywords: ['commission', 'statement', 'csv', 'xlsx', 'txt', 'paste', 'reconciliation'],
  },
] as const
