...
console.log('F. Wiring present')
{
  ...
  assert(billingPage.includes('confirmOnboardingHandoff'), 'Billing confirms subscription access before onboarding')
  assert(billingPage.includes('navigate(decision.path'), 'Billing navigates to onboarding only after gate ACTIVE')
