...
console.log('D. Pricing page + App route wiring present')
{
  ...
  assert(pricing.includes('contactSalesPath'), '51+ Contact ALZA uses sales inquiry route')
  assert(pricing.includes("contactSalesPath('pricing_contact')"), '51+ Contact ALZA source unchanged')
