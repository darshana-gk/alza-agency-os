...
console.log('D. Pricing page + App route wiring present')
{
  ...
  assert(pricing.includes('SELF_SERVE_INCLUDED'), 'one shared included-features list')
  assert(pricing.includes('Commission reconciliation'), 'includes commission reconciliation')
  assert(pricing.includes('Discrepancy tracking'), 'includes discrepancy tracking')
  assert(pricing.includes('Producer commissions'), 'includes producer commissions')
  assert(pricing.includes('Check'), 'lucide Check icons on self-serve cards')
  assert(!pricing.includes('Everything included'), 'no Everything included')
  assert(!pricing.includes('Most Popular'), 'no Most Popular')
  const customBlock = pricing.slice(pricing.indexOf('51+ users'))
  assert(!customBlock.includes('SELF_SERVE_INCLUDED'), 'custom/Flow Pay cards omit self-serve benefits')
