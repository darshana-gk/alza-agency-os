...
console.log('G2. Legacy-active + V2 catalog visibility (no second checkout)')
{
  ...
  assert(page.includes('data-billing-qa-marker="quote-first"'), 'QA marker attr on quote panel')
  assert(page.includes('QUOTE-FIRST BILLING QA · ffefc3c'), 'visible QA marker text')
  ...
  assert(!page.includes('Status is mirrored from Razorpay'), 'no Razorpay customer blurb')
