...
console.log('D. CTAs and dedicated pricing page still owns catalog')
{
  ...
  assert(talk.includes('contactSalesPath') || talk.includes('PUBLIC_CONTACT_SALES_PATH'), 'Talk to ALZA uses /contact-sales')
  ...
  assert(landing.includes("label: 'Contact us'"), 'landing header Contact us')
  assert(landing.includes("contactSalesPath('header_contact')"), 'landing header uses header_contact')
  assert(talk.includes('header_contact'), 'shared header Contact us uses header_contact')
  assert(talk.includes('Contact us'), 'pricing/public header Contact us')
